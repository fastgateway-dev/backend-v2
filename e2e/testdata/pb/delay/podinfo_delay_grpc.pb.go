...
const (
	DelayService_Delay_FullMethodName = "/delay.DelayService/Delay"
)
...
func (c *delayServiceClient) Delay(ctx context.Context, in *DelayRequest, opts ...grpc.CallOption) (*DelayResponse, error) {
	...
	err := c.cc.Invoke(ctx, DelayService_Delay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDelayServiceServer must be embedded to have
...
func (UnimplementedDelayServiceServer) testEmbeddedByValue()                      {}
...
func RegisterDelayServiceServer(s grpc.ServiceRegistrar, srv DelayServiceServer) {
	// If the following call panics, it indicates UnimplementedDelayServiceServer was
...
func _DelayService_Delay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DelayService_Delay_FullMethodName,
	}
